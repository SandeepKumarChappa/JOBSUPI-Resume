...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          JOBSUPI Resume saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets JOBSUPI Resume apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than JOBSUPI Resume, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, JOBSUPI Resume
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. JOBSUPI Resume is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, JOBSUPI Resume intentionally only offers
          ...
          like references. Additionally, JOBSUPI Resume only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. JOBSUPI Resume is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, JOBSUPI Resume believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          JOBSUPI Resume doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created JOBSUPI Resume and why?",
    answer: (
      <p>
        JOBSUPI Resume was created by{" "}
        <Link href="https://github.com/SandeepKumarChappa/JOBSUPI-Resume">Sandeep Kumar Chappa</Link> as
        a placement project. As many of us had made many mistakes
        ...
        and the collaboration became JOBSUPI Resume—a builder infused with the
        best practices we learned firsthand. Our hope is that JOBSUPI Resume can
        help anyone easily create a modern professional resume that follows best
        practices and enables everyone to apply for jobs with confidence.
      </p>
    ),
  },
  {
    question: "Q4. How can I support JOBSUPI Resume?",
    answer: (
      <>
        <p>
          The best way to support JOBSUPI Resume is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@jobsupi.com">hello@jobsupi.com</Link>{" "}
          or{" "}
          <Link href="https://github.com/SandeepKumarChappa/JOBSUPI-Resume">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support JOBSUPI Resume is by spreading the words.
