...
const FEATURES = [
  {
    src: featureFreeSrc,
    title: "Free Forever",
    text: "JOBSUPI Resume is created with the belief that everyone should have free and easy access to a modern professional resume design",
  },
  {
    src: featureUSSrc,
    title: "U.S. Best Practices",
    text: "JOBSUPI Resume has built-in best practices for the U.S. job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
    src: featurePrivacySrc,
    title: "Privacy Focus",
    text: "JOBSUPI Resume stores data locally in your browser so only you have access to your data and with complete control",
  },
  {
    ...
    text: (
      <>
        JOBSUPI Resume is an open-source project, and its source code can be viewed
        by anyone on its{" "}
