  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the JOBSUPI Resume
      ...
      <Paragraph>
        And that is everything about the JOBSUPI Resume parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="https://github.com/SandeepKumarChappa/JOBSUPI-Resume">Sandeep Kumar Chappa</Link> on
        November 2025
      </Paragraph>
    </article>
  );
